<?php
namespace Reflex\Repository\Eloquent;
...
use Reflex\Repository\Contracts\CriteriaInterface;
use Reflex\Repository\Contracts\Presentable;
use Reflex\Repository\Contracts\PresentableInterface;
use Reflex\Repository\Contracts\PresenterInterface;
use Reflex\Repository\Contracts\RepositoryCriteriaInterface;
use Reflex\Repository\Contracts\RepositoryInterface;
use Reflex\Repository\Events\RepositoryEntityCreated;
 ...
 * @package Reflex\Repository\Eloquent
 */
abstract class BaseRepository implements RepositoryInterface, RepositoryCriteriaInterface
{
    ...
    public function validator()
    {
        if (isset($this->rules) && !is_null($this->rules) && is_array($this->rules) && !empty($this->rules)) {
            if (class_exists('Prettus\Validator\LaravelValidator')) {
                ...
                throw new Exception(trans('repository::packages.Reflex_laravel_validation_required'));
            }
        }
    ...
    public function makeValidator($validator = null)
    {
        ...
        if (!is_null($validator)) {
            ...
            if (!$this->validator instanceof ValidatorInterface) {
                throw new RepositoryException("Class {$validator} must be an instance of Reflex\\Validator\\Contracts\\ValidatorInterface");
            }
     ...
     *
     * @return $this
     * @throws \Reflex\Repository\Exceptions\RepositoryException
     */
    public function pushCriteria($criteria)
    {
        ...
        if (!$criteria instanceof CriteriaInterface) {
            throw new RepositoryException("Class " . get_class($criteria) . " must be an instance of Reflex\\Repository\\Contracts\\CriteriaInterface");
        }
